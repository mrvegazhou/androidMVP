package com.effortapp.business.widget.mainHeader;
...
//        Log.e("error", ev.getActionIndex()+"---"+getScrollY()+"-----"+range);
...
//        }
    ...
    private void animateScroll(int t) {
        ...
        rl_top.setScaleX(t);
        ll_content.setScaleX(tvHeight * percent);
        tv.setScaleX(2 - percent);
        tv.setScaleY(2 - percent);
        tv.setTranslationX(tvWidth * (1 - percent) / 2f);
        tv.setTranslationY(t + tvHeight * (1 - percent) / 2f);
        ViewHelper.setTranslationY(ev, -t / 2);
        ev.setTranslationX(-t / 2);
