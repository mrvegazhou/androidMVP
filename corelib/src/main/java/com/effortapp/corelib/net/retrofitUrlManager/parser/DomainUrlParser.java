...
public class DomainUrlParser implements UrlParser {
    ...
    public HttpUrl parseUrl(HttpUrl domainUrl, HttpUrl url) {
        ...
        if (TextUtils.isEmpty(CacheUtil.get(getKey(domainUrl, url)))) {
            ...
            builder.encodedPath(CacheUtil.get(getKey(domainUrl, url)));
        }
        ...
        if (TextUtils.isEmpty(CacheUtil.get(getKey(domainUrl, url)))) {
            CacheUtil.put(getKey(domainUrl, url), httpUrl.encodedPath());
        }
        return httpUrl;
    }
