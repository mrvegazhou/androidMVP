 ...
 */
package com.effortapp.corelib.net.retrofitUrlManager.parser;
...
import static com.effortapp.corelib.net.retrofitUrlManager.RetrofitUrlManager.IDENTIFICATION_PATH_SIZE;
...
public class SuperUrlParser implements UrlParser {
    ...
    public HttpUrl parseUrl(HttpUrl domainUrl, HttpUrl url) {
        ...
        if (TextUtils.isEmpty(CacheUtil.get(getKey(domainUrl, url, pathSize)))) {
            ...
            builder.encodedPath(CacheUtil.get(getKey(domainUrl, url, pathSize)));
        }
        ...
        if (TextUtils.isEmpty(CacheUtil.get(getKey(domainUrl, url, pathSize)))) {
            CacheUtil.put(getKey(domainUrl, url, pathSize), httpUrl.encodedPath());
        }
        return httpUrl;
    }
