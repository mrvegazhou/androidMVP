...
import com.effortapp.corelib.net.function.RetryWithDelay;
        ...
        return new ObservableTransformer<T, T>() {
            ...
            public ObservableSource<T> apply(@NonNull Observable<T> upstream) {
                return upstream
                        ...
                        .compose(com.effortapp.corelib.rx.RxSchedulers.<T>bindToLifecycle(provider));
        ...
        return new ObservableTransformer<T, T>() {
            ...
            public ObservableSource<T> apply(@NonNull Observable<T> upstream) {
                return upstream
                        ...
                        .subscribeOn(Schedulers.io())
                        .observeOn(AndroidSchedulers.mainThread())
                        .compose(com.effortapp.corelib.rx.RxSchedulers.<T>bindToLifecycle(provider, event));
