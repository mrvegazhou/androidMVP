...
public final class ToastUtils {
    ...
    public static void setGravity(int gravity, int xOffset, int yOffset) {
        com.effortapp.corelib.utils.ToastUtils.gravity = gravity;
        com.effortapp.corelib.utils.ToastUtils.xOffset = xOffset;
        com.effortapp.corelib.utils.ToastUtils.yOffset = yOffset;
    }
    ...
    public static void setBackgroundColor(@ColorInt int backgroundColor) {
        com.effortapp.corelib.utils.ToastUtils.backgroundColor = backgroundColor;
    }
    ...
    public static void setBgResource(@DrawableRes int bgResource) {
        com.effortapp.corelib.utils.ToastUtils.bgResource = bgResource;
    }
    ...
    public static void setMessageColor(@ColorInt int messageColor) {
        com.effortapp.corelib.utils.ToastUtils.messageColor = messageColor;
    }
